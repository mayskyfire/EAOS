        ...
        <section class="page-section color no-padding-bottom">
            <div class="container">
                ...
                <div class="row wishlist">
                    <div class="col-md-12">
                        <table class="table wishlist_list">
                            <thead>
                                <tr>
                                    <th>Image</th>
                                    <th>Product Name</th>
                            ...
                            <tbody>
                                <?php /*?><tr>
                                    <td class="image"><a class="pull-left media-link" data-gal="prettyPhoto" href="img/preview/shop/product-1-big.jpg"><i class="fa fa-plus"></i><img src="img/preview/shop/order-1.jpg" alt=""/></a></td>
                                    <td class="description">
                                        <h4><a href="#">Electronic Product Name Header Here</a></h4>
                                        by Category Name
                                    </td>
                        ...
                        <a class="btn btn-theme btn-theme-transparent btn-icon-left btn-continue-shopping" href="?menu=category&type=shop"><i class="fa fa-shopping-cart"></i>Continue shopping</a>
                    </div>
